...
namespace Sonicteam{
	namespace SoX{
		...
		class ArcHandle:public IResource2HR(Sonicteam::SoX::ArcHandle,Sonicteam::SoX::ArcHandleMgr){

		public:
			ArcHandle();
			~ArcHandle();
			DESTRUCTION_H;
			LinkSoxNode<ArcHandle> LinkHandle; //0x64,0x68,0x6C
			...
			HANDLE FileHandle; //0xB0(need close btw)
		};
	};
};
